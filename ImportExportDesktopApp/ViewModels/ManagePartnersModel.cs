...
{
    class ManagePartnersModel : BaseNotifyPropertyChanged
    {
        private Pagination<Partner> _partners;
        ...
        public void Init()
        {
            Partners = HttpService.SearchPartner(null).Result;
            ...
            Paging.Size = Partners.Size;
            Paging.Page = Partners.Page;
            Paging.Type = null;
        ...
        public Pagination<Partner> Partners
        {
